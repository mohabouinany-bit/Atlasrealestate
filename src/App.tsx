...
export default function App() {
  ...
  useEffect(() => {
    ...
    bootstrap();
  }, [currentTab]); // Reload on tab changes to sync added/modified entries from admin
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-stone-800">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1.5 text-xs">
                <li><button onClick={() => setCurrentTab('home')} className="hover:text-white transition-colors cursor-pointer">{t('home')}</button></li>
                <li><button onClick={() => setCurrentTab('properties')} className="hover:text-white transition-colors cursor-pointer">{t('properties')}</button></li>
                <li><button onClick={() => setCurrentTab('about')} className="hover:text-white transition-colors cursor-pointer">{t('about')}</button></li>
                <li><button onClick={() => setCurrentTab('contact')} className="hover:text-white transition-colors cursor-pointer">{t('contact')}</button></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1.5 text-xs">
                <li><button onClick={() => { setFilters(prev => ({ ...prev, type: 'Masseria' })); setCurrentTab('properties'); }} className="hover:text-white transition-colors cursor-pointer">{t('casali')}</button></li>
                <li><button onClick={() => { setFilters(prev => ({ ...prev, type: 'Villa' })); setCurrentTab('properties'); }} className="hover:text-white transition-colors cursor-pointer">{t('ville')}</button></li>
                <li><button onClick={() => { setFilters(prev => ({ ...prev, type: 'Appartamento' })); setCurrentTab('properties'); }} className="hover:text-white transition-colors cursor-pointer">{t('appHist')}</button></li>
                <li><button onClick={() => { setFilters(prev => ({ ...prev, type: 'Rustico' })); setCurrentTab('properties'); }} className="hover:text-white transition-colors cursor-pointer">{t('rustici')}</button></li>
              </ul>
            </div>
