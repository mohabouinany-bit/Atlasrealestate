...
import { BedDouble, Bath, Maximize2, MapPin, ChevronLeft, ChevronRight, Phone, Mail, Check } from 'lucide-react';
...
export default function PropertyDetail({ property }: PropertyDetailProps) {
  ...
  return (
    <motion.div 
      ...
      className="bg-white rounded-2xl w-full overflow-hidden shadow-sm border border-stone-200"
    ...
    >
      ...
      <div className="flex justify-between items-center px-6 py-4 border-b border-stone-100">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="text-xs font-semibold text-stone-500 hover:text-stone-900 transition-colors cursor-pointer flex items-center gap-1"
        >
